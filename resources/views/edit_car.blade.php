      ...
      <div class="bg-light p-5 rounded">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" step="0.1" placeholder="Enter price" name="price" value="{{$car->price}}" class="form-control py-2" />
            </div>
          </div>
          <div class="form-group mb-3 row">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="checkbox" class="form-check-input" name="published" style="padding: 0.7rem;" @checked($car->published) />
            </div>
          </div>
